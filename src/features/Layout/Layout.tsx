...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50 text-slate-800 antialiased">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-white border-r border-slate-200 transition-transform duration-300 ease-in-out lg:hidden ${
...
function SidebarLinks() {
  const links = [
    { label: "Home Dashboard", path: "/user/dashboard", icon: Home },
    { label: "Analytics", path: "/user/analytics", icon: BarChart2 },
    { label: "Users", path: "/user/users", icon: Users },
    { label: "Settings", path: "/user/settings", icon: Settings },
    { label: "Help", path: "/user/help", icon: HelpCircle },
  ];
